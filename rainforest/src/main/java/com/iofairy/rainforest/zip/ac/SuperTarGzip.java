...
@ToString
@NoArgsConstructor
public class SuperTarGzip extends SuperACs {
    ...
    public SuperTarGzip(TarInputProperty unTarInputProperty, TarInputProperty reTarInputProperty, TarOutputProperty reTarOutputProperty,
                        GzipInputProperty unzipInputProperty, GzipInputProperty reZipInputProperty, GzipOutputProperty reZipOutputProperty) {
    ...
    public static SuperTarGzip of() {
        return new SuperTarGzip();
    }

    public static SuperTarGzip of(TarInputProperty unTarInputProperty, TarInputProperty reTarInputProperty, TarOutputProperty reTarOutputProperty,
                                  GzipInputProperty unzipInputProperty, GzipInputProperty reZipInputProperty, GzipOutputProperty reZipOutputProperty) {
        return new SuperTarGzip(unTarInputProperty, reTarInputProperty, reTarOutputProperty, unzipInputProperty, reZipInputProperty, reZipOutputProperty);
    }

    public SuperTarGzip setUnTarInputProperty(TarInputProperty unTarInputProperty) {
        this.unTarInputProperty = unTarInputProperty == null ? TarInputProperty.of() : unTarInputProperty;
        return this;
    }

    public SuperTarGzip setReTarInputProperty(TarInputProperty reTarInputProperty) {
        this.reTarInputProperty = reTarInputProperty == null ? TarInputProperty.of() : reTarInputProperty;
        return this;
    }

    public SuperTarGzip setReTarOutputProperty(TarOutputProperty reTarOutputProperty) {
        this.reTarOutputProperty = reTarOutputProperty == null ? TarOutputProperty.of() : reTarOutputProperty;
        return this;
    }

    public SuperTarGzip setUnzipInputProperty(GzipInputProperty unzipInputProperty) {
        this.unzipInputProperty = unzipInputProperty == null ? GzipInputProperty.of() : unzipInputProperty;
        return this;
    }

    public SuperTarGzip setReZipInputProperty(GzipInputProperty reZipInputProperty) {
        this.reZipInputProperty = reZipInputProperty == null ? GzipInputProperty.of() : reZipInputProperty;
        return this;
    }

    public SuperTarGzip setReZipOutputProperty(GzipOutputProperty reZipOutputProperty) {
        this.reZipOutputProperty = reZipOutputProperty == null ? GzipOutputProperty.of() : reZipOutputProperty;
        return this;
    }
    ...
    public <R> List<R> unzip(final InputStream is,
        ...
        GzipCompressorInputStream innerIs = null;
        try {
    ...
    public <R> ZipResult<R> reZip(final InputStream is,
        ...
        GzipCompressorInputStream innerIs = null;
        GzipCompressorOutputStream innerOs = null;
        try {
            ...
            String fileNameInGzip = SuperGzip.fileNameInGzip(innerIs, zipFileName, reZipInputProperty);
            GzipParameters gzipParameters = SuperGzip.getGzipParameters(reZipOutputProperty, fileNameInGzip);
            baos = new MultiByteArrayOutputStream();
            innerOs = new GzipCompressorOutputStream(baos, gzipParameters);
