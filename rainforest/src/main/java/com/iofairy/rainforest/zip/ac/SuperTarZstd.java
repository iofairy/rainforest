...
@ToString
@NoArgsConstructor
public class SuperTarZstd extends SuperACs {
    ...
    private ZstdInputProperty unzipInputProperty = ZstdInputProperty.of();
    private ZstdInputProperty reZipInputProperty = ZstdInputProperty.of();
    private ZstdOutputProperty reZipOutputProperty = ZstdOutputProperty.of();

    public SuperTarZstd(TarInputProperty unTarInputProperty, TarInputProperty reTarInputProperty, TarOutputProperty reTarOutputProperty,
                        ZstdInputProperty unzipInputProperty, ZstdInputProperty reZipInputProperty, ZstdOutputProperty reZipOutputProperty) {
        ...
        this.unzipInputProperty = unzipInputProperty == null ? ZstdInputProperty.of() : unzipInputProperty;
        this.reZipInputProperty = reZipInputProperty == null ? ZstdInputProperty.of() : reZipInputProperty;
        this.reZipOutputProperty = reZipOutputProperty == null ? ZstdOutputProperty.of() : reZipOutputProperty;
    }

    public static SuperTarZstd of() {
        return new SuperTarZstd();
    }

    public static SuperTarZstd of(TarInputProperty unTarInputProperty, TarInputProperty reTarInputProperty, TarOutputProperty reTarOutputProperty,
                                  ZstdInputProperty unzipInputProperty, ZstdInputProperty reZipInputProperty, ZstdOutputProperty reZipOutputProperty) {
        return new SuperTarZstd(unTarInputProperty, reTarInputProperty, reTarOutputProperty, unzipInputProperty, reZipInputProperty, reZipOutputProperty);
    }

    public SuperTarZstd setUnTarInputProperty(TarInputProperty unTarInputProperty) {
        this.unTarInputProperty = unTarInputProperty == null ? TarInputProperty.of() : unTarInputProperty;
        return this;
    }

    public SuperTarZstd setReTarInputProperty(TarInputProperty reTarInputProperty) {
        this.reTarInputProperty = reTarInputProperty == null ? TarInputProperty.of() : reTarInputProperty;
        return this;
    }

    public SuperTarZstd setReTarOutputProperty(TarOutputProperty reTarOutputProperty) {
        this.reTarOutputProperty = reTarOutputProperty == null ? TarOutputProperty.of() : reTarOutputProperty;
        return this;
    }

    public SuperTarZstd setUnzipInputProperty(ZstdInputProperty unzipInputProperty) {
        this.unzipInputProperty = unzipInputProperty == null ? ZstdInputProperty.of() : unzipInputProperty;
        return this;
    }

    public SuperTarZstd setReZipInputProperty(ZstdInputProperty reZipInputProperty) {
        this.reZipInputProperty = reZipInputProperty == null ? ZstdInputProperty.of() : reZipInputProperty;
        return this;
    }

    public SuperTarZstd setReZipOutputProperty(ZstdOutputProperty reZipOutputProperty) {
        this.reZipOutputProperty = reZipOutputProperty == null ? ZstdOutputProperty.of() : reZipOutputProperty;
        return this;
    }
    ...
    public <R> List<R> unzip(final InputStream is,
        ...
        ZstdInputStream innerIs = null;
        try {
            if (unzipACMap == null) unzipACMap = toSuperACMap(superACs);

            innerIs = new ZstdInputStream(is, unzipInputProperty.getBufferPool());
            setZstdInputStreamOptions(innerIs, unzipInputProperty);
    ...
    public <R> ZipResult<R> reZip(final InputStream is,
        ...
        ZstdInputStream innerIs = null;
        ZstdOutputStream innerOs = null;
        try {
            if (reZipACMap == null) reZipACMap = toSuperACMap(superACs);

            innerIs = new ZstdInputStream(is, reZipInputProperty.getBufferPool());
            setZstdInputStreamOptions(innerIs, reZipInputProperty);
            ...
            innerOs = new ZstdOutputStream(baos, reZipOutputProperty.getBufferPool());
            setZstdOutputStreamOptions(innerOs, reZipOutputProperty);
