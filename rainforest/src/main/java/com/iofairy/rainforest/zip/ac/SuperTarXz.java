...
@ToString
@NoArgsConstructor
public class SuperTarXz extends SuperACs {
    ...
    public SuperTarXz(TarInputProperty unTarInputProperty, TarInputProperty reTarInputProperty, TarOutputProperty reTarOutputProperty,
                      XzInputProperty unzipInputProperty, XzInputProperty reZipInputProperty, XzOutputProperty reZipOutputProperty) {
    ...
    public static SuperTarXz of() {
        return new SuperTarXz();
    }

    public static SuperTarXz of(TarInputProperty unTarInputProperty, TarInputProperty reTarInputProperty, TarOutputProperty reTarOutputProperty,
                                XzInputProperty unzipInputProperty, XzInputProperty reZipInputProperty, XzOutputProperty reZipOutputProperty) {
        return new SuperTarXz(unTarInputProperty, reTarInputProperty, reTarOutputProperty, unzipInputProperty, reZipInputProperty, reZipOutputProperty);
    }

    public SuperTarXz setUnTarInputProperty(TarInputProperty unTarInputProperty) {
        this.unTarInputProperty = unTarInputProperty == null ? TarInputProperty.of() : unTarInputProperty;
        return this;
    }

    public SuperTarXz setReTarInputProperty(TarInputProperty reTarInputProperty) {
        this.reTarInputProperty = reTarInputProperty == null ? TarInputProperty.of() : reTarInputProperty;
        return this;
    }

    public SuperTarXz setReTarOutputProperty(TarOutputProperty reTarOutputProperty) {
        this.reTarOutputProperty = reTarOutputProperty == null ? TarOutputProperty.of() : reTarOutputProperty;
        return this;
    }

    public SuperTarXz setUnzipInputProperty(XzInputProperty unzipInputProperty) {
        this.unzipInputProperty = unzipInputProperty == null ? XzInputProperty.of() : unzipInputProperty;
        return this;
    }

    public SuperTarXz setReZipInputProperty(XzInputProperty reZipInputProperty) {
        this.reZipInputProperty = reZipInputProperty == null ? XzInputProperty.of() : reZipInputProperty;
        return this;
    }

    public SuperTarXz setReZipOutputProperty(XzOutputProperty reZipOutputProperty) {
        this.reZipOutputProperty = reZipOutputProperty == null ? XzOutputProperty.of() : reZipOutputProperty;
        return this;
    }
