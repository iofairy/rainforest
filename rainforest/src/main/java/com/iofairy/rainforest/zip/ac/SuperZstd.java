...
@ToString
@NoArgsConstructor
public class SuperZstd extends SuperACs {
    ...
    public SuperZstd(ZstdInputProperty unzipInputProperty, ZstdInputProperty reZipInputProperty, ZstdOutputProperty reZipOutputProperty) {
    ...
    public static SuperZstd of() {
        return new SuperZstd();
    }

    public static SuperZstd of(ZstdInputProperty unzipInputProperty, ZstdInputProperty reZipInputProperty, ZstdOutputProperty reZipOutputProperty) {
        return new SuperZstd(unzipInputProperty, reZipInputProperty, reZipOutputProperty);
    }

    public SuperZstd setUnzipInputProperty(ZstdInputProperty unzipInputProperty) {
        this.unzipInputProperty = unzipInputProperty == null ? ZstdInputProperty.of() : unzipInputProperty;
        return this;
    }

    public SuperZstd setReZipInputProperty(ZstdInputProperty reZipInputProperty) {
        this.reZipInputProperty = reZipInputProperty == null ? ZstdInputProperty.of() : reZipInputProperty;
        return this;
    }

    public SuperZstd setReZipOutputProperty(ZstdOutputProperty reZipOutputProperty) {
        this.reZipOutputProperty = reZipOutputProperty == null ? ZstdOutputProperty.of() : reZipOutputProperty;
        return this;
    }
    ...
    public <R> List<R> unzip(final InputStream is,
        ...
        ZstdInputStream zipis = null;
        try {
            if (unzipACMap == null) unzipACMap = toSuperACMap(superACs);

            String entryFileName = ZipKit.getUncompressedName(zipFileName, format());

            zipis = new ZstdInputStream(is, unzipInputProperty.getBufferPool());
            setZstdInputStreamOptions(zipis, unzipInputProperty);
    ...
    public <R> ZipResult<R> reZip(final InputStream is,
        ...
        try {
            ...
            zipis = new ZstdInputStream(is, reZipInputProperty.getBufferPool());
            setZstdInputStreamOptions(zipis, reZipInputProperty);
            String entryFileName = ZipKit.getUncompressedName(zipFileName, format());

            baos = new MultiByteArrayOutputStream();
            zos = new ZstdOutputStream(baos, reZipOutputProperty.getBufferPool());
            setZstdOutputStreamOptions(zos, reZipOutputProperty);
