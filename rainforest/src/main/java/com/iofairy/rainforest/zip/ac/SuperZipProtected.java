...
public class SuperZipProtected implements SuperAC {
    ...
    private static ZipModel getZipModel(ZipModel zipModel) {
        /*
    ...
    private static ZipParameters getParameters(ZipParameters defaultZipParameters, String entryFileName, boolean encrypted) {
