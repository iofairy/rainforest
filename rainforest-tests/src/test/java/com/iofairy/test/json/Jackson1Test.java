...
public class Jackson1Test {
    ...
    void testDeserializer1() {
        ...
        System.out.println("============================================================");
        /// ////////////////////////////////////
        String s2 = "\" [-∞ ,  '2025/01/15 20:11:05.025' ] \"";
        ...
        try {
            ...
            assertSame(e.getClass(), JsonParseException.class);
            assertEquals(e.getMessage(), "The string ' [-∞ ,  '2025/01/15 20:11:05.025' ] ' cannot be parsed to a `Range` instance for type [com.iofairy.range.Range<com.iofairy.falcon.map.ComparableMap<java.lang.String,java.lang.Object>>]. \n" +
                    " at [Source: REDACTED (`StreamReadFeature.INCLUDE_SOURCE_IN_LOCATION` disabled); line: 1, column: 39]");
        }
        try {
            ...
            assertSame(e.getClass(), JsonParseException.class);
            assertEquals(e.getMessage(), "The string ' [-∞ ,  '2025/01/15 20:11:05.025' ] ' cannot be parsed to a `Range` instance for type [com.iofairy.range.Range<java.lang.Integer>]. \n" +
                    " at [Source: REDACTED (`StreamReadFeature.INCLUDE_SOURCE_IN_LOCATION` disabled); line: 1, column: 39]");
        }
        ...
        try {
            String s3 = "\" [-∞ ,  '2025-01-15 20:11:05' ] \"";
            mapper.readValue(s3, Range.class);
        } catch (JsonProcessingException e) {
            assertSame(e.getClass(), JsonParseException.class);
