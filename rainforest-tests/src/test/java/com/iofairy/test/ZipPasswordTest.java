...
public class ZipPasswordTest {
    ...
    void testZipPassword() {
        ...
        // [ZipPassword{fileName='a【文】b[]()', pattern=a【文】b\[]\(\), password=[C@4b9e255}, ZipPassword{fileName='a【文】b[]()-cd', pattern=a【文】b\[]\(\)\-cd, password=[C@5e57643e}, ZipPassword{fileName='a【文】b[]()-+$cde??', pattern=a【文】b\[]\(\)\-\+$cde.., password=[C@1d7acb34}, ZipPassword{fileName='a【文】b[]()-+$cde*', pattern=a【文】b\[]\(\)\-\+$cde.*, password=[C@4f51b3e0}, ZipPassword{fileName='a【文】b[]()-+$?fg', pattern=a【文】b\[]\(\)\-\+$.fg, password=[C@1e4a7dd4}, ZipPassword{fileName='a【文】b[]()-+$*fg', pattern=a【文】b\[]\(\)\-\+$.*fg, password=[C@48a242ce}, ZipPassword{fileName='?【文】???()', pattern=.【文】...\(\), password=[C@1ad282e0}, ZipPassword{fileName='*a【文】*b*', pattern=.*a【文】.*b.*, password=[C@51b279c9}]
        System.out.println(passwordProvider.getZipPasswordList());
        assertEquals(passwordProvider.getZipPasswordList().toString(), "[ZipPassword(fileName=a【文】b[](), pattern=a【文】b\\[]\\(\\)), ZipPassword(fileName=a【文】b[]()-cd, pattern=a【文】b\\[]\\(\\)\\-cd), ZipPassword(fileName=a【文】b[]()-+$^cde.??, pattern=a【文】b\\[]\\(\\)\\-\\+\\$\\^cde\\...), ZipPassword(fileName=a【文】b[]()-+$^cde.*, pattern=a【文】b\\[]\\(\\)\\-\\+\\$\\^cde\\..*), ZipPassword(fileName=a【文】b[]()-+$^?fg, pattern=a【文】b\\[]\\(\\)\\-\\+\\$\\^.fg), ZipPassword(fileName=a【文】b[]()-+$^*fg, pattern=a【文】b\\[]\\(\\)\\-\\+\\$\\^.*fg), ZipPassword(fileName=?【文】???(), pattern=.【文】...\\(\\)), ZipPassword(fileName=*a【文】*b?, pattern=.*a【文】.*b.)]");
        System.out.println("============================================================");
        ...
        // [ZipPassword{fileName='a【文】b[]()', pattern=a【文】b\[]\(\), password=[C@4b9e255}, ZipPassword{fileName='a【文】b[]()-cd', pattern=a【文】b\[]\(\)\-cd, password=[C@5e57643e}, ZipPassword{fileName='a【文】b[]()-+$cde??', pattern=a【文】b\[]\(\)\-\+$cde.., password=[C@1d7acb34}, ZipPassword{fileName='a【文】b[]()-+$cde*', pattern=a【文】b\[]\(\)\-\+$cde.*, password=[C@4f51b3e0}, ZipPassword{fileName='a【文】b[]()-+$?fg', pattern=a【文】b\[]\(\)\-\+$.fg, password=[C@1e4a7dd4}, ZipPassword{fileName='a【文】b[]()-+$*fg', pattern=a【文】b\[]\(\)\-\+$.*fg, password=[C@48a242ce}, ZipPassword{fileName='?【文】???()', pattern=.【文】...\(\), password=[C@1ad282e0}, ZipPassword{fileName='*a【文】*b*', pattern=.*a【文】.*b.*, password=[C@51b279c9}, ZipPassword{fileName='*', pattern=.*, password=[C@2bea5ab4}]
        System.out.println(passwordProvider.getZipPasswordList());
